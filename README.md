...
Меня зовут Журавлева Лариса, я начинающий Prompt Engineer, специализирующийся на работе с нейросетями и большими языковыми моделями (LLM). Имею опыт в создании и оптимизации промптов, разработке AI-ассистентов и чат-ботов, интеграции AI-решений в бизнес-процессы, а также в реализации проектов по автоматизации бизнес-процессов.
